/*
   DFR0300 ----- Arduino ------- Raspberry Pi 3
   Arduino Code Sources: https://github.com/DFRobot/Analog-Electrical-Conductivity-Sensor/blob/master/EC_calibration.ino
   However, Temp sensor is connected to the Raspberry pie 3.
   Temp sensor ------ DHT 22
...
#define ecSensorPin  A0  //EC Meter analog output,pin on analog 0
#define ds18b20Pin  2    //DS18B20 signal, pin on digital 2, Temp Sensor
...
//  Raspberry Pi 에서 Temp 값을 입력 받게 할 코드를 써야할 곳
float readTemperature()
{
  while(Serial.available()>0){
    float tempvalue = Serial.parseInt();
    return tempvalue; 
  }
}
